...
- 目标：按三份 V2 规格文档完成 V2 升级（Host/Session 隔离、Thread Hold、Hook-only Mailbox）与 Kimi Code 适配；ZCode 插件资源与真实 E2E 明确推后。
...
- 环境事实：本机 Codex runtime 为 ChatGPT.app 内嵌 0.153.4；确定性回归基线为 V2 收口后 212/212（2026-09-12，含 T4 收口轮）。
